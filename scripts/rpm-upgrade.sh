...
mirror_url=$(rpm_get_mirror_url "$prev_major_version" "$dist_name" "$version_name" "$arch")
archive_url=$(rpm_get_archive_url "$prev_major_version" "$dist_name" "$version_name" "$arch")
